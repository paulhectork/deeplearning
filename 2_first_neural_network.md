...
- then, the MLP is just a composition of layers all functions $$f \in F_n$$ alternating with an activation function $$a$$ : 

$$F = \\{ f_{K} \circ a \circ ... \circ a \circ f_{1} | f_{1} \in F_{1}, ..., F_{K} \\}$$
